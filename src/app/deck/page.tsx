...
function Nav() {
  return (
    <motion.nav
      ...
      className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 py-4 md:px-12 bg-black/80 backdrop-blur-md border-b border-white/5"
    >
      <Link
        href="/"
        className="font-heading font-bold text-xl tracking-widest text-neon-green text-glow-green"
      >
        SCROLLTOLL
      </Link>
      <a
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            {
              num: "2hrs 23min",
              label: "Average daily social media time globally",
              color: "text-neon-green",
              glow: "rgba(57,255,20,0.15)",
            },
            {
              num: "$226B",
              label: "Social media ad revenue (they profit from your addiction)",
              color: "text-hot-pink",
              glow: "rgba(255,46,151,0.15)",
            },
            {
              num: "0",
              label: "Apps that make your scrolling actually matter",
              color: "text-electric-purple",
              glow: "rgba(191,0,255,0.15)",
            },
          ].map((stat, i) => (
            <GlowCard key={i} delay={i * 0.15} glowColor={stat.glow}>
              <div className={`font-heading text-4xl md:text-5xl font-bold mb-4 ${stat.color}`}>
                {stat.num}
              </div>
  ...
  const steps = [
    {
      ...
      desc: "Choose which apps to monitor and how long you're \"allowed\" to scroll.",
      icon: "⚙️",
    },
    {
      num: "02",
      title: "SCROLL INTO THE VOID",
      desc: "Use your phone normally. We monitor in the background via Apple Screen Time.",
      icon: "📱",
    },
    {
      num: "03",
      title: "THE TOLL APPEARS",
      desc: "Exceed your limit? A full-screen shield drops: FEED THE VOID or walk away.",
      icon: "🛡️",
    },
    {
      num: "04",
      title: "YOUR GUILT DOES GOOD",
      desc: "One tap donates to charity. Your doom scrolling just fed a child.",
      icon: "💚",
    },
  ];
    ...
    <AnimatedSection className="py-16 md:py-24 px-6 md:px-12 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
          ...
          <br />
          <span className="text-neon-green text-glow-green">Doom Scrolling.</span>
        </h2>
        <p className="text-white/50 text-lg mb-16 max-w-2xl">
          Not a blocker. Not a timer. A toll &mdash; with teeth.
        </p>
            ...
            >
              ...
              <div className="flex-1 pb-6 border-b border-white/5">
                <div className="flex items-center gap-3 mb-2">
                  ...
                  <h3 className="font-heading text-lg md:text-xl font-semibold tracking-wide">
                    {step.title}
                  </h3>
                </div>
  ...
  const quotes = [
    {
      ...
      attribution: "Shield notification",
      color: "border-neon-green/30 hover:border-neon-green/60",
    },
    {
      text: "\"Congratulations. You just doom scrolled for 47 minutes and fed a child. Hero.\"",
      attribution: "Post-donation confirmation",
      color: "border-hot-pink/30 hover:border-hot-pink/60",
    },
    {
      text: "\"Not now, mortal.\"",
      attribution: "Dismiss button (the walk of shame)",
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {quotes.map((q, i) => (
            ...
            >
              <p className="text-neon-green font-mono text-base md:text-lg leading-relaxed whitespace-pre-line">
                {q.text}
              </p>
        ...
        >
          <p className="text-white/40 text-base italic">
            The goal isn&apos;t to make people feel bad. It&apos;s to make the habit visible
            &mdash; so they can change it. Like a casino showing the clock. Except we&apos;re on
            your side.
          </p>
        </motion.div>
      </div>
    ...
    <AnimatedSection className="py-16 md:py-24 px-6 md:px-12 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <p className="text-white/50 text-lg mb-16">
          Digital wellness market: $2.1B by 2027 &nbsp;|&nbsp; Charitable giving via apps:
          $4.1B annually
        </p>
...
function Revenue() {
  const streams = [
    ...
    },
    {
      icon: "🏢",
      title: "B2B WELLNESS",
      desc: "$5-10/employee/month. Corporate digital wellness with ESG reporting.",
      when: "MONTH 6",
      color: "text-electric-purple",
      glow: "rgba(191,0,255,0.15)",
    },
    {
      ...
      desc: "Nonprofits pay for featured placement in the donation shield. $500-5K/month.",
      when: "MONTH 6",
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {streams.map((stream, i) => (
            <GlowCard
              key={i}
              delay={i * 0.12}
              glowColor={stream.glow}
              className="flex flex-col justify-between"
            >
              <div>
                <div className="text-4xl mb-4">{stream.icon}</div>
                <h3 className={`font-heading font-bold text-base tracking-wide mb-3 ${stream.color}`}>
                  {stream.title}
                </h3>
                <p className="text-white/50 text-sm leading-relaxed">{stream.desc}</p>
              </div>
              <div className={`mt-6 font-mono text-xs font-bold ${stream.color}`}>
                {stream.when}
              </div>
            </GlowCard>
          ))}
  ...
  const tolls = [
    {
      ...
      desc: "The core toll. One tap, money goes to a real nonprofit. Guilt becomes impact.",
      tag: "CORE",
      tagColor: "bg-neon-green text-black",
    },
    {
      title: "SWEAR JAR",
      desc: "Set a dollar amount. Every time you exceed your limit, it goes into a pot. Cash out or donate monthly.",
      tag: "V2",
      tagColor: "bg-hot-pink text-white",
    },
    {
      title: "SOCIAL SHAME",
      desc: "Auto-post your scroll time to social. \"I just spent 2 hours on TikTok. I'm not okay.\" (opt-in, obviously.)",
      tag: "V2",
      tagColor: "bg-electric-purple text-white",
    },
    {
      title: "FRIEND TAX",
      desc: "Your doom scrolling buys your friend a coffee via Venmo. They'll definitely tell you about it.",
      tag: "V3",
      tagColor: "bg-toxic-yellow text-black",
    },
    {
      title: "ACCOUNTABILITY BUDDY",
      desc: "Automated text to someone you trust: \"Hey, Patrick just doom scrolled for 45 minutes straight.\"",
      tag: "V3",
      tagColor: "bg-toxic-yellow text-black",
    },
    {
      title: "CORPORATE WELLNESS",
      desc: "Teams compete. Lowest collective scroll time wins a team lunch. Worst team buys pizza.",
      tag: "B2B",
      tagColor: "bg-hot-pink text-white",
    },
  ];
  ...
  return (
    <AnimatedSection className="py-16 md:py-24 px-6 md:px-12">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-4">
          The Toll Can Be <span className="text-electric-purple text-glow-purple">Anything.</span>
        </h2>
          ...
          {tolls.map((toll, i) => (
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <h3 className="font-heading font-bold text-base text-neon-green tracking-wide">
                  {toll.title}
                </h3>
                <span className={`px-2.5 py-1 rounded-full text-xs font-bold ${toll.tagColor}`}>
                  {toll.tag}
                </span>
              </div>
              <p className="text-white/50 text-sm leading-relaxed">{toll.desc}</p>
            </GlowCard>
          ))}
        </div>
      </div>
  ...
  return (
    <AnimatedSection className="py-16 md:py-24 px-6 md:px-12 relative">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <h2 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold mb-16">
          Not a Pitch. <span className="text-neon-green text-glow-green">A Product.</span>
        </h2>
            ...
            <div className="space-y-3">
              {status.map((item, i) => (
                ...
                >
                  ...
                  <span className={`font-mono font-bold text-xs ${item.color}`}>
                    {item.state}
                  </span>
                </motion.div>
              ))}
      ...
      <div className="relative z-10 max-w-3xl mx-auto">
        ...
        >
          ...
          <h2 className="font-heading text-4xl md:text-6xl lg:text-7xl font-bold mb-6">
            <span className="text-neon-green text-glow-green">THE VOID</span>
            <br />
        ...
        >
          Your doom scrolling could feed a child, plant a tree, or provide clean water &mdash;
          every single day. All it costs is your guilt.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
